...
-- AddForeignKey
ALTER TABLE `pomodoro_round` ADD CONSTRAINT `pomodoro_round_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `pomodoro_session`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
